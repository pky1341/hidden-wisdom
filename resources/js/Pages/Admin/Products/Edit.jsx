    ...
    return (
        <AdminLayout>
            ...
            <div className="mb-8">
                ...
                <h1 className="mt-3 text-3xl font-bold text-gray-800">Edit Product</h1>
            </div>
            ...
            <div className="max-w-3xl rounded-lg bg-white p-8 shadow">
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        <div>
                            <label className="mb-2 block text-sm font-medium text-gray-700">Replace PDF (max 50MB)</label>
                            <input
                                type="file"
                            ...
                            />
                            {product.file_path && (
                                <p className="mt-1 text-xs text-gray-500">Current: {product.file_path}</p>
                            )}
                            {errors.pdf && <p className="mt-1 text-sm text-red-600">{errors.pdf}</p>}
                        </div>
                        <div>
                            <label className="mb-2 block text-sm font-medium text-gray-700">Replace Preview Image</label>
                            <input
                                type="file"
                                accept="image/*"
